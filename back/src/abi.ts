export const abi = [
  ...
  {
    inputs: [],
    name: 'OnlyTopLevelDomainAllowed',
    type: 'error',
  },
  {
    inputs: [
  ...
  {
    inputs: [],
    name: 'ParentDomainIsNotRegistered',
    type: 'error',
  },
  {
    inputs: [],
